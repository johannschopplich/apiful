...
declare module 'apiverse/schema' {
  import { paths as SampleApiPaths } from 'apiverse/__sampleApi__'
  import { paths as PetStorePaths } from 'apiverse/__petStore__'

  interface OpenAPISchemaRepository {
    sampleApi: SampleApiPaths
    petStore: PetStorePaths
  }
}

declare module 'apiverse/__sampleApi__' {
...
declare module 'apiverse/__petStore__' {
  export interface paths {
      "/pet": {
          parameters: {
              query?: never;
