...
> = Omit<
  FetchOptions,
  'baseURL' | 'params' | 'query' | 'headers' | 'method' | 'body'
> &
RequestBody<P[Lowercase<M>]> &
PathParameters<P[Lowercase<M>]> &
QueryParameters<P[Lowercase<M>]> &
RequestMethod<M>
...
export type GetPaths<Paths> = {
  [P in keyof Paths]: Paths[P] extends { get: any }
